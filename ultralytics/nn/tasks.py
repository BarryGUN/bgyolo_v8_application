...
from ultralytics.nn.modules.block import MS2, MS2b, C2RepX, SplitMP,  MS2d, MS2e, C2d, C2sc, C2RepXc, \
     C2x, C2fSA, C2el, C2ft, TranConcat, TranQKVConcat, SPPFDWC
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, SPPFDWC,
                 ...
                 MS2, MS2b, C2RepX, SplitMP, MS2d, MS2e, C2d, C2sc, C2RepXc, C2ft,
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, MS2, MS2b, C2RepX,
                     MS2d, MS2e, C2d, C2sc, C2RepXc, C2x, C2fSA, C2el, C2ft):
        ...
        elif m in [TranConcat, TranQKVConcat]:
            c2 = sum(ch[x] for x in f)
            args = [c2,  args[0]]
